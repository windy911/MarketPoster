package com.rambo.marketposter.widget.flashview;
...
import com.rambo.marketposter.widget.flashview.effect.AccordionTransformer;
import com.rambo.marketposter.widget.flashview.effect.CubeTransformer;
import com.rambo.marketposter.widget.flashview.effect.DefaultTransformer;
import com.rambo.marketposter.widget.flashview.effect.DepthPageTransformer;
import com.rambo.marketposter.widget.flashview.effect.InRightDownTransformer;
import com.rambo.marketposter.widget.flashview.effect.InRightUpTransformer;
import com.rambo.marketposter.widget.flashview.effect.RotateTransformer;
import com.rambo.marketposter.widget.flashview.effect.ZoomOutPageTransformer;
...
public class FlashView extends FrameLayout {
    ...
    public static final int TIME_SCROLL = 1000;
...
//        System.out.println("测试bug111：：：imageUris.size()" + imageUris.size());
        ...
        if (imageUris.size() <= 1)//图片小于等于1张时，不轮播
        {
            ...
            try {
                ...
                scroller.setmDuration(TIME_SCROLL);
    ...
    public void setDotsVisable(boolean show) {
        mLinearLayout.setVisibility(show ? View.VISIBLE : View.GONE);
    }
